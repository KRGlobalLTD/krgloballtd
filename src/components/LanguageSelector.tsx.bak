...
export function LanguageSelector({ currentLanguage, onLanguageChange, t }: LanguageSelectorProps) {
  ...
  return (
    <div className="relative">
      <button
        className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-black hover:text-neutral-600 transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 rounded-lg"
